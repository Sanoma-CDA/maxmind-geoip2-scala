...
class CoordinateConversions_test extends AnyFlatSpec with should.Matchers {
  ...
  "CoordinateConversions" should "wgs842etrs89tm35fin" in {
  ...
  "CoordinateConversions" should "etrs89tm35fin2wgs84" in {
    for (pair <- points2test) {
      val P = pair._1
      val NE = pair._2
